...
public static class EnumExtensions
{
    ...
    public static string FriendlyName(this StatType t)
    {
        return t switch
        {
    ...
    public static string Abbrev(this StatType t)
    {
        return t switch
        {
    ...
    public static string FriendlyName(this GearSetManager manager)
    {
    ...
    public static string FriendlyName(this GroupType groupType)
    {
    ...
    public static string FriendlyName(this GearSetSlot slot, bool detailed = false)
    {
        return (slot, detailed) switch
        {
    ...
    public static string FriendlyName(this ItemSource source)
    {
    ...
    public static string FriendlyName(this InstanceType source)
    {
        return source switch
        {
    ...
    public static string FriendlyName(this Role role)
    {
        return role switch
        {
