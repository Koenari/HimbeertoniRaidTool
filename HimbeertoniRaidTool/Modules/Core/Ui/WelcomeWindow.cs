...
internal class WelcomeWindow : HrtWindow
{
    ...
    public override void Draw()
    {
        ...
        ImGui.TextWrapped(Localize("WelcomeWindowLine4",
            "The plugin will always update the gear for characters that were added to a group or solo tab when examining the character in-game."));
        ImGui.TextWrapped(Localize("WelcomeWindowLine5",
            "To really start using this you'd need to add your group via the \"+ button\" right to the Solo tab. For this you have two possibilities."
            +
        ...
        ImGui.TextWrapped(Localize("WelcomeWindowLine6",
            "If you for example want the loot master to open on start, I would suggest you take a quick look at the options. And go to the wiki for more detailed instructions :)"));
        ImGui.NewLine();
        //Buttons
